        ...
        <Fragment>
            <div className={styles.link_info_item}>
                <div className={styles.link_info}>
                    <div><a onClick={clickUrl(url_id)} target='_blank'  rel="noreferrer" href={url_value}>{url_name}</a></div>
                    <div>
                ...
                <div className={styles.link_info_content}>
                    <a onClick={clickUrl(url_id)} href={url_value} target="_blank" rel='noreferrer'>{url_info}</a>
                </div>
            </div>
