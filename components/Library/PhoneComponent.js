            ...
            {UrlList.map(category => {
                ...
                return(
                    <Panel key={url_id} style={{borderBottom:'1px solid #bfbfbf',fontSize:14}} header={
                        <a onClick={clickUrl(url_id)} target='_blank' rel='noreferrer' href={url_value}>
                            <span style={{
                                color:'#262626',
                        ...
                        <a onClick={clickUrl(url_id)} target='_blank'  rel="noreferrer" href={url_value}><span style={{color:'#8c8c8c'}}>{url_info}</span></a>
                    </Panel>
                )
            })}
        </Collapse>
