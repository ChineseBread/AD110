...
export default function CustomFooter() {
	...
	return (
		<div className={styles.footer}>
			...
			<span>
				<Link href='/custom/check?pageid=3'>广告投放</Link> | <Link href='/custom/check?pageid=4'>投稿</Link>  (包括文章、作品或自荐) | <Link href='/index'>录入网址</Link> | <Link href='/custom/check?pageid=5'>报错</Link> | <Link href='/custom/check?pageid=5'>帮助</Link>
			</span>
			<span>
