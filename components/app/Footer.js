...
export default function Footer(props) {
	...
	return (
		<div className={styles.footer}>
			...
			<span>
				<Link href='/custom/check?pageid=5'>关于 AD110</Link> | <Link href='/custom/check?pageid=18'>工作机会</Link> | <Link href='/custom/check?pageid=5'>联系 AD110</Link>
			</span>
			<span>
				<Link href='/custom/check?pageid=3'>广告投放</Link> | <Link href='/custom/check?pageid=4'>投稿 (包括文章、作品或自荐)</Link> | <Link href='/uploadurl'>录入网址</Link> | <Link href='/custom/check?pageid=5'>报错</Link> | <Link href='/custom/check?pageid=5'>帮助</Link>
			</span>
			<span>
				<Link href='/custom/check?pageid=5'>Part of the ooogo Family</Link> | <Link href='/custom/check?pageid=5'>&copy; AD110</Link>
			</span>
		</div>
	);
}
